...
Public Class searchformCAT1
    Public con As New SqlConnection(My.Settings.MARKETDBConnectionString)

    Private Sub searchform_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        con.Open()
        Dim cmd2 As New SqlCommand("SELECT pname FROM stock where (code = '' OR code IS NULL)", con)
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ' orderfrm3.pn.Text = pn.Text
        'orderfrm3.categ.Text = cat.Text
        orderfrm1.categoriesComboBox.SelectedItem = cat.Text
